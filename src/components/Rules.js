    ...
    this.state = {
      ...
      data: {
          ...
          element: (
            <div className="rules-text content">
              <ul>
                ...
                <li>
                  Each player can make 3 steps on a cell near his active dots
                  (viruses) during his turn.
                </li>
              </ul>
            </div>
          ),
        ...
        2: {
          ...
          element: (
            <div className="rules-text content">
              <ul>
                <li>
                  If you make a step on opponents virus, you create a base.
                </li>
        ...
        3: {
          ...
          element: (
            <div className="rules-text content">
              <ul>
                <li>
                  Any base, that have a virus or <b>active</b> base near it is
                  active.
                </li>
              </ul>
            </div>
        ...
        4: {
          ...
          element: (
            <content className="rules-text content">
              <ul>
                <li>
                  You can make steps on cells that are near viruses, or active
                  bases.
                </li>
          ...
          element: (
            <div className="rules-text content">
              <ul>
                ...
                <li>
                  That's it! What the winning move for white would be here?
                </li>
              </ul>
            </div>
          ),
  ...
  render() {
    return (
      <div>
        ...
        <div className="container">
          <div className="columns">
            <div className="column is-5-tablet rules-image">
              <img
                src={this.state.data[this.state.currentSlide].imgSrc}
                alt="screen shot"
              />
            </div>
        ...
        <div
          disabled={
            this.state.currentSlide === Object.keys(this.state.data).length
          }
        ...
        <div
          disabled={this.state.currentSlide === 1}
        ...
        <div
          className="button rules-button rules-back-button button-on-danger"
